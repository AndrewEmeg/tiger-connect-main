...
export default function ServicesNew() {
    ...
    const onSubmit = async (values: z.infer<typeof formSchema>) => {
        ...
        try {
            ...
            console.log(
                "Service listing successful, data:",
                listingResult.data
            );
            ...
            try {
                ...
                if (
                    ...
                    serviceId = (listingResult.data as { id: string }).id;
                    console.log("Found service ID from object:", serviceId);
                } else {
                    console.log(
                        "Data returned:",
                        JSON.stringify(listingResult.data)
                    );
                }

                if (serviceId) {
                    console.log(
                        `Creating notification for service ID: ${serviceId} and user ID: ${user?.user_id}`
                    );
