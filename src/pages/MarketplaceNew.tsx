            ...
            try {
                ...
                if (listingResult.data) {
                    if (
                        ...
                        const firstItem = listingResult.data[0];
                        if (
                            firstItem &&
                ...
                if (itemId) {
                    console.log(
                        `Creating notification for item ID: ${itemId} and user ID: ${user?.user_id}`
                    );
                    ...
                    console.warn(
                        "Item ID not found in response, skipping notification creation"
                    );
                }
